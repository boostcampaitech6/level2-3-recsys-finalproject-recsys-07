...
def main(args):
    ...
    key_dict = {}
    range_dict = {1: range(8826,337507060,800),2: range(337507060,675005294,800),3: range(675005294,1012503528,800),4: range(1012503528,1350001762,800),5: range(1350001762,1687500000,800)}
...
if __name__ == "__main__":
    ...
    parser.add_argument('--version', action='store',dest='version',type=int, help='choose version')
